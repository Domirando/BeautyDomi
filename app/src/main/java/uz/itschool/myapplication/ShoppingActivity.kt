...
class ShoppingActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        product_list_v.add(Product(R.string.peeling, 2540, R.string.peeling_desc, R.drawable.oip__1__removebg_preview, Color.parseColor("#F5CAC3"), null, "vertical"))
        product_list_v.add(Product(R.string.toner, 2540, R.string.toner_desc, R.drawable.oip__2__removebg_preview, Color.parseColor("#B6D7CF"), null, "vertical"))
        ...
        product_list_v.add(Product(R.string.serum, 2540, R.string.serum_desc, R.drawable.oip__2__removebg_preview, Color.parseColor("#F5CAC3"),null, "vertical"))
